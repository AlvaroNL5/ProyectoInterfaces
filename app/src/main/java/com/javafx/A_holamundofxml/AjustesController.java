...
public class AjustesController {
    ...
    public void initialize() {
        ...
        Platform.runLater(() -> {
            if (lblIdUsuario.getScene() != null) {
                FadeTransition fadeIn = new FadeTransition(Duration.millis(300), lblIdUsuario.getScene().getRoot());
    ...
    private void aplicarTema(Alert alert) {
        try {
