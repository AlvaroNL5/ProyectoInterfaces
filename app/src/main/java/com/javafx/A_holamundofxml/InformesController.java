...
public class InformesController {
    ...
    private static final String CARPETA_INFORMES = System.getProperty("user.home") + File.separator + "Documents" + File.separator + "Muudle" + File.separator + "INFORMES";
    ...
    private void generarInformeCursos() throws Exception {
        try (Connection conn = DatabaseConnection.getConnection()) {
            ...
            String nombreBase = CARPETA_INFORMES + File.separator + "InformeCursos";
    ...
    private void generarInformeMatriculas() throws Exception {
        try (Connection conn = DatabaseConnection.getConnection()) {
            ...
            String nombreBase = CARPETA_INFORMES + File.separator + "InformeMatriculas";
            guardarInformeEnArchivos(print, nombreBase);
    ...
    private void generarInformeCondicional() throws Exception {
        ...
        try (Connection conn = DatabaseConnection.getConnection()) {
            ...
            String nombreBase = CARPETA_INFORMES + File.separator + "InformeCondicional";
            guardarInformeEnArchivos(print, nombreBase);
