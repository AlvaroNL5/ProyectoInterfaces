...
/**
 * Controlador del formulario de auto-registro.
 * Se accede SOLO desde el boton "Registrarse" del Login: todo usuario
 * que se registre desde aqui sera siempre rol "alumno". Los profesores
 * deben crearse a mano en la BD por el administrador.
 */
public class CrearUsuarioController {
    ...
    private void crearUsuario() {
        ...
        try (Connection conn = DatabaseConnection.getConnection()) {
            ...
            // Auto-registro siempre crea alumnos; los profesores los provisiona el admin.
            stmt.setString(5, "alumno");
